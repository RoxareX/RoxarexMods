...
public class ConfigUtils {
	...
	public static ButtonOption createShortcutToKeybindsScreen() {
		...
		return ButtonOption.createBuilder()
				.name(Component.translatable("roxarexmods.config.shortcutToKeybindsSettings"))
				.action(screen -> client.gui.setScreen(new KeyBindsScreen(screen, client.options)))
				.prompt(Component.translatable("roxarexmods.config.shortcutToKeybindsSettings.@Text"))
				.build();
	}
